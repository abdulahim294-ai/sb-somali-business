...
export default function Dashboard() {
  ...
  const { data: myApps, isLoading: appsLoad } = useMyApplications(
    user?.id ?? null
  );
                  ...
                  >
                    ...
                    <div>
                      <div className="font-display font-bold text-xl text-slate-900 tabular-nums">
                        {loading ? (
                          <div className="h-6 w-12 skeleton inline-block" />
                        ) : (
                          s.value
                        )}
                      </div>
                ...
                {jobsLoad ? (
                  ...
                  <div className="p-10 text-center">
                    ...
                    <p className="font-semibold text-slate-700 mb-1">
                      Weli shaqo ma daabacin
                    </p>
                    <p className="text-sm text-muted-foreground mb-4">
                      Daabac shaqadaada hore ee maanta.
                    </p>
                    <Link href="/post-job">
                  ...
                  <div className="divide-y divide-border/50">
                    {myJobs.map((j) => (
                      <div
                        key={j.id}
                        className="flex items-center justify-between gap-3 px-5 py-3.5 hover:bg-slate-50/60 transition-colors"
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <Badge
                            variant={
                              j.status === "active" ? "success" : "secondary"
                            }
                            className="text-[11px]"
                          >
              ...
              <section className="bg-white rounded-2xl border border-border/60 shadow-sm overflow-hidden">
                ...
                {appsLoad ? (
                  ...
                  <div className="p-10 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Raadi shaqo oo si toos ah u codso.
                    </p>
                    <Link href="/jobs">
                      <Button size="sm" variant="outline">
                        Raadi shaqooyin
                ...
                >
                  <div>
                    ...
                    <span className="font-semibold">
                      {plan.limits.jobsPerMonth < 0
                        ? "Aan xaddidnayn"
                        : plan.limits.jobsPerMonth}
                    </span>
                  </div>
                  <div>
                    Codsi / bil:{" "}
                    <span className="font-semibold">
                      {plan.limits.appsPerMonth < 0
                        ? "Aan xaddidnayn"
                        : plan.limits.appsPerMonth}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    },
                    {
                      href: "/create-profile",
                      icon: UserCircle2,
                      label: "Samee/cusbooneysii profile",
                      color: "text-emerald-600",
                    },
                    {
                      href: "/jobs",
                      icon: Briefcase,
                      label: "Raadi shaqooyin",
                      color: "text-sky-600",
                    },
                    {
                      href: "/pricing",
                      icon: Crown,
                      label: "Eeg qorshooyinka",
                      color: "text-amber-600",
                    },
                  ].map((a) => (
                    <Link key={a.href} href={a.href}>
                      <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
                        <a.icon
                          className={cn("w-4 h-4 shrink-0", a.color)}
                        />
